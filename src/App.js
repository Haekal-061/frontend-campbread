  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {
          // use localStorage as fallback to avoid redirect race right after login
        }
        <Route path="/profile" element={
          <ProtectedRoute isAllowed={isLoggedIn || Boolean(localStorage.getItem(TOKEN_KEY))}>
        ...
        <Route
          path="/admin"
          element={
            <ProtectedRoute isAllowed={(isLoggedIn || Boolean(localStorage.getItem(TOKEN_KEY))) && (userRole === 'admin' || localStorage.getItem(ROLE_KEY) === 'admin')}>
