  ...
  const handleSaveProduct = async () => {
    try {
      if (modeModal === 'add') {
        ...
        Swal.fire({ icon: 'success', title: 'Produk berhasil ditambahkan', toast: true, position: 'center', timer: 1500, showConfirmButton: false });
      } else {
        ...
        Swal.fire({ icon: 'success', title: 'Produk berhasil diperbarui', toast: true, position: 'center', timer: 1500, showConfirmButton: false });
      }
      setShowModal(false);
      fetchProducts();
    } catch (error) {
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        Swal.fire({ icon: 'success', title: 'Produk berhasil dihapus', toast: true, position: 'center', timer: 1500, showConfirmButton: false });
        fetchProducts();
      } catch (error) {
        console.error(error);
